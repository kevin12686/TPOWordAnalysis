...
from .views import Tools, UploadArticle, WordRestore, Ranking, StopwordsList, StopwordsCreate, StopwordsDelete, LearnedList, LearnedCreate, LearnedDelete, ArticleDetail, WordDetail
